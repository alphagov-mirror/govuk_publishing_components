  ...
  describe "#structured_data" do
    ...
    context "schema.org GovernmentService" do
      ...
      it 'generates schema.org GovernmentService with basic properties' do
        ...
        expect(structured_data['serviceType']).to eql('This service lets you apply for a license to keep your dragon at home.')
        expect(structured_data['description']).to eql('Your dragon must have a home. Applying for your dragon housing license is free of charge.')
      ...
      it 'generates schema.org GovernmentService with provider when at least one organisation exists' do
        ...
        expect(structured_data['provider']).to eql(expected_provider)
      end
      ...
      def transaction_content_item(organisations = [], ordered_related_items = [])
        ...
        content_item['details'].merge!(
          "introductory_paragraph" => "Your dragon must have a home.",
          "more_information" => "Applying for your dragon housing license is free of charge."
        )
    ...
    it "generates schema.org GovernmentService" do
      content_item = GovukSchemas::RandomExample.for_schema(frontend_schema: "transaction")
